 ...
 */
@Slf4j
public class XyyDrugCorpusDealDictionaryTask {
    ...
    private String tryParseBrand(String brand) {
        brand = XyyDrugCorpusUtils.replaceSpecialChar(brand);
    ...
    public void makeDosageDictionary() throws IOException {
        ...
        for (String dosage : dosageArray) {
            dosage = XyyDrugCorpusUtils.replaceSpecialChar(dosage);
...
// ====================================================================================================
    ...
    private String tryParseCorp(String original) {
        original = XyyDrugCorpusUtils.replaceSpecialChar(original);
