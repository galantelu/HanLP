...
public class XyySegmentBadCase {
    ...
    public void testStandardSegment() {
        ...
        /* 药品 or 成分 */
        CustomDictionary.insert("磷酸氢钙", XyyNatureEnum.core.getNature().toString() + " 1024");
        CustomDictionary.insert("维D2", XyyNatureEnum.core.getNature().toString() + " 1024");
        CustomDictionary.insert("维生素D", XyyNatureEnum.core.getNature().toString() + " 1024");
        CustomDictionary.insert("碳酸钙", XyyNatureEnum.core.getNature().toString() + " 1024");
        CustomDictionary.insert("D3", XyyNatureEnum.core.getNature().toString() + " 1024");
        /* 修饰词 */
        CustomDictionary.insert("采森牌", XyyNatureEnum.qualifier.getNature().toString() + " 1024");
        /* 剂型 */
        CustomDictionary.insert("钙片", XyyNatureEnum.dosage.getNature().toString() + " 1024");
        CustomDictionary.insert("片", XyyNatureEnum.dosage.getNature().toString() + " 1024");
...
//        log.info("【CRF分词】文本【{}】结果：{}", text, globalCRFLexicalAnalyzer.analyze(text));
        ...
        StandardTokenizer.SEGMENT.enableIndexMode(1);
